	...
	return (
		<div className="space-y-2">
			...
			<ScrollArea className="w-full">
				<pre className="bg-muted/50 rounded-lg p-4 font-mono text-xs">
					{code}
				</pre>
...
export function MutationSidebar({
	config,
	showConfig = false,
}: MutationSidebarProps) {
	const apiBaseUrl =
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Use these snippets to call this mutation via API
				</CardDescription>
			</CardHeader>
