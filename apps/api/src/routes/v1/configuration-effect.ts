 ...
 */
export default async function configurationEffectRoutes(
	...
	fastify.post<{ Body: CreateConfigurationBody }>(
		'/v1/effect/workspace/:workspaceId/configuration',
		{
	...
	fastify.get<{ Params: ConfigurationParams }>(
		'/v1/effect/workspace/:workspaceId/configuration/:configurationId',
		{
			schema: {
				params: {
					type: 'object',
